 ...
 */
class IsCaptureSuccessfulConditionPlugin extends AbstractPlugin implements ConditionInterface
{
    /**
     * {@inheritDoc}
     * - Checks if `SalesOrderItem.PaymentFirstDataItem` has status "captured".
     *
     * @api
     *
    ...
    public function check(SpySalesOrderItem $orderItem): bool
    {
        ...
        return $firstDataItem->getStatus() === $this->getConfig()->getOmsStatusCaptured();
    }
}
